...
Lets move on to our next scenario where we will not use the devices in our lab. The instructor will present [Scenario 5 - MTR onboarding](./scenarios/MTROnBoardingFromCH.md).